...
class CgvCrudController extends AbstractCrudController
{
    ...
    {
        return $crud
        ->setPageTitle('index', 'Conditions générales de vente')
        ->setPageTitle('edit', 'Conditions générales de vente')
        ->setPageTitle('new', 'Conditions générales de vente')
        ->setPageTitle('detail', 'Conditions générales de vente')
        ;
    }
